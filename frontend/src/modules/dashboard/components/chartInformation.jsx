...
function intermediateCode(tipo) {
    if (tipo === "mapas_coropleticos") {
        return (<pre className="text-xs bg-gray-100 p-3 rounded whitespace-pre-wrap max-h-[300px] overflow-auto">
                    {`brasil = (
...
export default function ChartInformation({ pergunta, dados, tipo }) {
    return (<>
